...
if (! function_exists('format_money')) {
     ...
     */
    function format_money(float|int $amount, ?string $currency = null, ?string $locale = null): string
    {
...
if (! function_exists('active_route')) {
     ...
     */
    function active_route(array|string $routes, string $activeClass = 'active'): string
    {
...
if (! function_exists('set_article_seo')) {
    ...
    function set_article_seo(
        ...
        SeoHelper::setArticle($title, $description, $url, $image, $publishedTime, $author);
    }
}
